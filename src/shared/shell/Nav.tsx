  ...
  return (
    <>
      <header className="sbd-app-header sticky top-0 z-40 pt-[env(safe-area-inset-top,0px)] backdrop-blur-xl backdrop-saturate-150 md:z-50">
        <div className="mx-auto flex w-full max-w-4xl items-center gap-2 py-2 pl-[max(0.75rem,env(safe-area-inset-left))] pr-[max(0.75rem,env(safe-area-inset-right))] sm:gap-3 sm:py-3 sm:pl-[max(1rem,env(safe-area-inset-left))] sm:pr-[max(1rem,env(safe-area-inset-right))] md:max-w-6xl md:gap-4 md:pl-[max(1.5rem,env(safe-area-inset-left))] md:pr-[max(1.5rem,env(safe-area-inset-right))] xl:pl-[max(2rem,env(safe-area-inset-left))] xl:pr-[max(2rem,env(safe-area-inset-right))]">
        <Link
          href="/dashboard"

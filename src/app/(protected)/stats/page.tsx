          ...
          <aside className="border-t border-white/[0.06] p-5 sm:p-6">
            <div className="space-y-4 text-sm leading-relaxed text-zinc-400">
              <p>
                ...
                від 1 (легко) до 10 (максимум), з точністю до тисячних. На тижневих графіках —
                база — топ-RPE найважчої сесії; кожна додаткова сесія тієї ж вправи трохи
                піднімає показник (легка — менше, важка — більше), не виходячи за 10. Backoff
                усередині дня не розводить оцінку. Тижні без цієї вправи між першим і останнім
                тренуванням показуються як спад до 5 (не нуль).
              </p>
              <p>
                RPE підходу зберігається в момент запису/оновлення підходу (від максу, який тоді був у
                профілі) і більше не змінюється, коли ти піднімаєш максимум. Нова формула оцінки
                діє для нових і щойно відредагованих підходів; якщо RPE ще немає — для графіка
                береться оцінка від поточного максу.
              </p>
              <p>
                Графік суми максимумів будується зі збережених значень у профілі.
              </p>
            </div>
          </aside>
        </details>
